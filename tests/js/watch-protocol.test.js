...
test('watch identifiers, copy, and low-power presence frames stay bounded', () => {
  ...
  assert.deepEqual(presenceFrame('listening', 2), { coreColor: 0x00e5ff, glyph: '◈', ring: 2 })
  assert.deepEqual(presenceFrame('thinking', 3), { coreColor: 0x675cff, glyph: '◇', ring: 0 })
  assert.deepEqual(presenceFrame('speaking', 4), { coreColor: 0xb9f6ff, glyph: '◆', ring: 1 })
})
